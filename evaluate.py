...
dataset_name = "/home/justin/yumi/detectron2_repo/datasets/detectron_agg"
#for d in ['train', 'test']:
d = "test"
...
# evaluate the model
cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "/home/justin/yumi/detectron2_repo/models/knot_detect_1.pth")  # path to the model we just trained
cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.1   # set a custom testing threshold
predictor = DefaultPredictor(cfg)

# COCOEVAL:
import json
evaluator = COCOEvaluator("loop_test", output_dir="datasets/output")
